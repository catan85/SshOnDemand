    ...
    public class Queries
        {
            ...
            public Core.Entities.DeviceConnectionStatus CheckDeviceConnection(sshondemandContext dbContext, string deviceName)
            {
            ...
            public bool IsDeviceConnectionRequested(sshondemandContext dbContext, string deviceName)
            {
            ...
            public void SetDeviceConnectionDetails(sshondemandContext dbContext, string deviceName, Core.Entities.DeviceConnectionStatus status)
            {
            ...
            public void SetDeviceConnectionState(sshondemandContext dbContext, string deviceName, EnumClientConnectionState state)
            {
            ...
            public List<int> GetForwardingPorts(sshondemandContext dbContext)
            {
            ...
            public bool IsDeveloperConnectionToDeviceAuthorized(sshondemandContext dbContext, string developerName, string deviceName)
            {
                return dbContext.DeveloperAuthorizations
                    .Any(c => c.Developer.ClientName == developerName && c.Device.ClientName == deviceName);
            }

            public void InsertDeviceConnectionRequest(sshondemandContext dbContext, string deviceName, string developerName)
            {
            ...
            public void DeactivateOldRequests(sshondemandContext dbContext, int maxRequestAgeInSeconds, out List<string> deactivatedClients)
            {
            ...
            public void ResetOldConnections(sshondemandContext dbContext, int maxConnectionAgeInSeconds, out List<string> deactivatedClients)
            {
